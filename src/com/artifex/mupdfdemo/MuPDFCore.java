...
//	static {
//		try {
//			NativeUtils.loadLibraryFromJar("/libmupdf.so");	 
//	    } catch (IOException e) { 
//	    	System.err.println("Exception when loading lib");
...
//	}
	...
	{
		System.out.println("MuPDFCore constructor");
		globals = openFile(filename);
		System.out.println("MuPDFCore constructor 1");
		if (globals == 0)
		{
			throw new Exception(String.format("Cannot open file path ", filename));
		}
		file_format = fileFormatInternal();
		System.out.println("MuPDFCore constructor end");
	}
